...
Confluence.Templates.User.logo = function(opt_data, opt_sb) {
  ...
  if (opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) {
    output.append('<a ', (opt_data.canView) ? ' class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '', ' href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("Add a picture of yourself"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.19/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml("Add a picture of yourself"), '"></a>');
  } else {
    if (opt_data.profilePictureInfo.anonymous) {
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.19/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml("Anonymous"), '" title="', soy.$$escapeHtml("Anonymous"), '">');
      ...
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.19/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml(opt_data.username), '" title="', soy.$$escapeHtml(opt_data.username), '">');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_sb) {
  ...
  if (opt_data.userInfo.userName == null) {
    ...
    output.append('<a class="userLogoLink" data-username="', soy.$$escapeHtml(opt_data.userInfo.userName), '" href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("Add a picture of yourself"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.19/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml("Add a picture of yourself"), '"></a>');
  } else {
...
try {
AJS.toInit(function(){Confluence.Blueprint.register("com.lucidchart.confluence.plugins.lucid-confluence:create-page-with-diagram",function(a,b){window.location=Confluence.getContextPath()+"/pages/createpage.action?spaceKey="+encodeURIComponent(b)+(a.getParentPageId()?"&fromPageId="+a.getParentPageId():"")+"&showLucidchartDocsList=true"})});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
try {
AJS.toInit(function(e){var a=function(h){h.prevPage();h.page.pop()},d=function(h){h.remove()},g=function(k,j,i,h){AJS.log("Creating page containing survey id: "+k+" title: "+j+" spaceKey: "+i);h(j,{surveyId:k})},f=function(i,j,h,k){if(k!=""){k="/"+k}AJS.log("Create Survey From Template ID:"+i);AJS.$.ajax({url:Confluence.getContextPath()+"/rest/adaptavist-survey/1.0/create-from-template/"+i+"/"+j+k,dataType:"json",type:"POST"}).then(function(l){g(l.id,l.title,j,h)},function(l){AJS.messages.error(".aui-message-bar",{title:"Survey Create Failed",body:Adaptavist.Templates.Survey.createDialog.createFromTemplateErrorMessage({templateId:i,event:l}),closeable:true})})},b=function(k,m,j,h){var n=k.addPage("survey-create-step-2"),l=function(){var s,p,r,q=o.find(":checked");if(q.length==0){AJS.messages.error(".aui-message-bar",{title:"No Survey checked",body:"Please select a survey",closeable:true});return false}if(q.hasClass("survey-template")){p=q.data("index");s=h.templates[p].id;r=e("#template-new-title").attr("value");f(s,m,j,r)}else{p=q.data("index");r=h.surveys[p].title;s=h.surveys[p].id;AJS.log("using title "+r+" for id: "+s);g(s,r,m,j)}},i=function(p){a(p);a(p)},o;n.addHeader("Survey").addPanel("SinglePanel",Adaptavist.Templates.Survey.createDialog.form({spaceKey:m,surveyData:h}),"singlePanel").addButton("Back",i,"survey-create-back-button").addButton("Create",l,"survey-create-create-button aui-button aui-button-primary").addLink("Cancel",d,"survey-create-cancel-link");AJS.tabs.setup();o=e("#survey-create-dialog-form");o.submit(function(){l(k);return false});e("a.survey-tab-link").bind("click",function(){o[0].reset();return true});return false},c=function(i,j,h){var k=i.addPage("survey-create-step-2");k.addHeader("Survey").addPanel("SinglePanel",Adaptavist.Templates.Survey.createDialog.loading(),"singlePanel").addButton("Back",a,"survey-create-back-button").addLink("Cancel",d,"survey-create-cancel-link");AJS.$.ajax({url:Confluence.getContextPath()+"/rest/adaptavist-survey/1.0/dialog-data/"+j,dataType:"json",type:"GET"}).then(function(l){var o=l.surveys,m=l.templates,n=function(p){return p.sort(function(r,q){return r.title.localeCompare(q.title)})};l.surveys=n(o);l.templates=n(m);l.surveysLength=o.length;l.templatesLength=m.length;b(i,j,h,l)},function(l){AJS.messages.error("#survey-load-message-bar",{title:"Survey Data Error",body:Adaptavist.Templates.Survey.createDialog.dialogDataErrorMessage({event:l}),closeable:true})});return false};Confluence.Blueprint.register("com.adaptavist.confluence.survey:survey-create-dialog",c)});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
try {
// This file was automatically generated from create-template.soy.
// Please don't edit this file by hand.

if (typeof Adaptavist == 'undefined') { var Adaptavist = {}; }
if (typeof Adaptavist.Templates == 'undefined') { Adaptavist.Templates = {}; }
if (typeof Adaptavist.Templates.Survey == 'undefined') { Adaptavist.Templates.Survey = {}; }
if (typeof Adaptavist.Templates.Survey.createDialog == 'undefined') { Adaptavist.Templates.Survey.createDialog = {}; }


Adaptavist.Templates.Survey.createDialog.dialogDataErrorMessage = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<p>', soy.$$escapeHtml("Failed to fetch Survey data from the server"), '</p><p>', soy.$$escapeHtml(opt_data.event.status), '  ', soy.$$escapeHtml(opt_data.event.statusText), '</p>');
  return opt_sb ? '' : output.toString();
};


Adaptavist.Templates.Survey.createDialog.createFromTemplateErrorMessage = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<p>', soy.$$escapeHtml("Failed to create survey from template id:"), ' ', soy.$$escapeHtml(opt_data.templateId), '</p><p>', soy.$$escapeHtml(opt_data.event.status), ' ', soy.$$escapeHtml(opt_data.event.statusText), '</p>');
  return opt_sb ? '' : output.toString();
};


Adaptavist.Templates.Survey.createDialog.loading = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<h1>Loading</h1><div id="survey-load-message-bar"></div>');
  return opt_sb ? '' : output.toString();
};


Adaptavist.Templates.Survey.createDialog.surveyTable = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<table class="aui">', (opt_data.count > 0) ? '<thead><tr><th></th><th class="survey-title">' + soy.$$escapeHtml("Title") + ' s</th><th class="survey-title">' + soy.$$escapeHtml("ID") + '</th><th class="survey-description">' + soy.$$escapeHtml("Description") + '</th><th class="survey-sections">' + soy.$$escapeHtml("Questions") + '</th></tr></thead>' : '', '<tbody><fieldset class="group survey-create-select-group">');
  var surveyList36 = opt_data.surveys;
  var surveyListLen36 = surveyList36.length;
  if (surveyListLen36 > 0) {
    for (var surveyIndex36 = 0; surveyIndex36 < surveyListLen36; surveyIndex36++) {
      var surveyData36 = surveyList36[surveyIndex36];
      output.append('<tr><td><input id="survey-id-', soy.$$escapeHtml(surveyData36.id), '-', soy.$$escapeHtml(opt_data.inputName), '" class="radio ', soy.$$escapeHtml(opt_data.inputName), '" type="radio" name="survey-id-', soy.$$escapeHtml(opt_data.inputName), '" data-index="', soy.$$escapeHtml(surveyIndex36), '"></td><td class="survey-title" nowrap>', soy.$$escapeHtml(surveyData36.title), '</td><td class="survey-id">', soy.$$escapeHtml(surveyData36.id), '</td><td class="survey-description">', (surveyData36.description) ? soy.$$escapeHtml(surveyData36.description) : '<span class="smalltext">' + soy.$$escapeHtml("None") + '</span>', '</td><td class="survey-sections">', soy.$$escapeHtml(surveyData36.questionCount), '</td></tr>');
      if (surveyIndex36 == surveyListLen36 - 1) {
        switch (opt_data.inputName) {
          case 'survey-template':
            output.append('<tr><td class="survey-title">', soy.$$escapeHtml("New title"), '</td><td colspan="4"><input type="text" id="template-new-title" name="template-new-title" value=""/></td></tr>');
            break;
        }
      }
    }
  } else {
    output.append('<tr><td colspan="5"><div class="aui-message closeable shadowed">');
    var contextPath__soy71 = "";
    var create_url__soy72 = contextPath__soy71 + '/survey/manage/list.action?key=' + opt_data.spaceKey;
    switch (opt_data.inputName) {
      case 'survey':
        output.append('<p class="title"><span class="aui-icon icon-generic"></span><strong>', soy.$$escapeHtml("No surveys to select!"), '</strong></p>', AJS.format("\x3cp\x3eThere are currently no surveys to select in this space. \x3c/p\x3e \x3cp\x3eCreate some surveys \x3ca href\x3d\x22{0}\x22\x3e from scratch\x3c/a\x3e or from a survey template!\x3c/p\x3e",create_url__soy72));
        break;
      case 'survey-template':
        output.append('<p class="title"><span class="aui-icon icon-generic"></span><strong>', soy.$$escapeHtml("No survey templates to select!"), '</strong></p>', AJS.format("\x3cp\x3eThere are currently no survey templates to select in this space. \x3c/p\x3e \x3cp\x3eCreate some survey templates \x3ca href\x3d\x22{0}\x22\x3efrom scratch \x3c/a\x3e or select an existing survey to use!\x3c/p\x3e",create_url__soy72));
        break;
    }
...
Adaptavist.Templates.Survey.createDialog.form = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="aui-message-bar"></div><p>', soy.$$escapeHtml("Create your own custom survey to gather feedback from your team."), '</p><form id="survey-create-dialog-form" class="aui"><div class="aui-tabs horizontal-tabs"><ul class="tabs-menu"><li class="menu-item active-tab"><a href="#survey-create-existing" class="survey-tab-link">', soy.$$escapeHtml("Select an existing Survey"), '</a></li><li class="menu-item"><a href="#survey-create-from-template" class="survey-tab-link">', soy.$$escapeHtml("Create a new Survey from a template"), '</a></li></ul><input type="hidden" value="', soy.$$escapeHtml(opt_data.spaceKey), '"><div id="survey-create-existing" class="tabs-pane active-pane">');
  Adaptavist.Templates.Survey.createDialog.surveyTable({surveys: opt_data.surveyData.surveys, inputName: 'survey', spaceKey: opt_data.spaceKey, count: opt_data.surveyData.surveysLength}, output);
  output.append('</div><div id="survey-create-from-template" class="tabs-pane">');
  Adaptavist.Templates.Survey.createDialog.surveyTable({surveys: opt_data.surveyData.templates, inputName: 'survey-template', spaceKey: opt_data.spaceKey, count: opt_data.surveyData.templatesLength}, output);
